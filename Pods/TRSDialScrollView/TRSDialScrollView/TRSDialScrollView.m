...
-(void)setMYminorTicksPerMajorTick:(NSInteger)mYminorTicksPerMajorTick
{
    self.dialView.minorTicksPerMajorTick = mYminorTicksPerMajorTick;
}
...
- (void)setCurrentValue:(NSInteger)newValue animated:(BOOL)animated {
